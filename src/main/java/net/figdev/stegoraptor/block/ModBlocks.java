...
public class ModBlocks {
    ...
    public static final Block CORN_CROP = Registry.register(Registries.BLOCK, new Identifier(StegoRaptor.MOD_ID, "corn_crop"),
    ...
    public static final Block POTTED_DAHLIA = Registry.register(Registries.BLOCK,
            new Identifier(StegoRaptor.MOD_ID, "potted_dahlia"),
